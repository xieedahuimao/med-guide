...
const MEDS = {
  paracetamol: {
    ...
    contraindications: [
      '严重肝、肾功能不全的人禁用。',
      '对扑热息痛（对乙酰氨基酚）或成分过敏的人禁用。',
      '有肝病、肝肾功能不太好的人，用之前先问医生。',
      '别和别的含对乙酰氨基酚的退烧/感冒药一起吃（会超量）。',
      '吃药这几天别喝酒；长期喝酒的人用之前先问医生。',
      '孕妇、哺乳期慎用（先问医生）；对阿司匹林过敏的人慎用。',
      '正在吃华法林等抗凝药、或氟氯西林（一种抗生素）的人，用之前先问医生。',
    ],
  ...
  ibuprofen: {
    ...
    type: '解热镇痛抗炎（非甾体抗炎药 NSAID）',
    form: '成人一次 1 粒（0.3g），一天 2 次（早晚各一次），饭后吃。止痛连用不超过 5 天、退烧不超过 3 天。',
    maxNote: '缓释胶囊必须整粒吞服，别嚼碎、别拆开。一天 2 粒。',
    contraindications: [
      '对布洛芬、阿司匹林或其他非甾体抗炎药过敏的人禁用。',
      '孕妇及哺乳期妇女禁用。',
      '一吃阿司匹林就哮喘的人禁用。',
      '有肝病、肾病、心脏病的人禁用。',
      '正在吃其他布洛芬/非甾体抗炎药的人禁用（除非医生让吃）。',
      '有胃溃疡、消化道出血/穿孔史、或正在胃肠出血的人禁用。',
      '60 岁以上、有哮喘/鼻息肉、凝血障碍、高血压、心功能不全、溃疡性结肠炎/克罗恩病的人慎用（先问医生）。',
      '吃药期间别喝酒。',
    ],
    groups: ['nsaid'],
  },
  ...
  aspirin: {
    ...
    contraindications: [
      '孕妇、哺乳期妇女禁用。',
      '有哮喘、鼻息肉、或对阿司匹林等解热镇痛药过敏的人禁用。',
      '有血友病、血小板减少症、或溃疡病活动期的人禁用。',
      '有胃溃疡/胃出血史的人别用。',
      '正在吃抗凝药（华法林、肝素）或溶栓药的人别用。',
      '痛风、肝肾减退、心功能不全、鼻出血、月经过多、溶血性贫血史的人慎用。',
      '吃药期间别喝酒。',
    ],
  ...
  diclofenac_gel: {
    name: '双氯芬酸二乙胺乳胶剂（外用药膏）',
    alias: '（常见商品名：扶他林软膏）',
    type: '外用非甾体抗炎药（涂在皮肤上的）',
  ...
  loratadine: {
    ...
    contraindications: [
      ...
      '和酮康唑、大环内酯类抗生素、西咪替丁、茶碱一起吃会升高血药浓度，要慎用。',
    ],
  ...
  cetirizine: {
    ...
    contraindications: [
      '对西替利嗪、羟嗪或其他哌嗪类药过敏的人禁用。',
      '严重肾功能损害（肌酐清除率＜10ml/min）的人禁用。',
      '哺乳期妇女别用（会进入母乳）；妊娠头 3 个月不推荐。',
      '有尿潴留（前列腺肥大）、癫痫的人慎用。',
      '吃药期间别开车、别高空作业。',
      '和安眠药、茶碱一起吃要谨慎。',
    ],
  ...
  hydrotalcite: {
    ...
    contraindications: [
      '对本品过敏的人禁用。',
      '严重肾功能不全（肌酐清除率＜30ml/min）的人禁用。',
      '低磷血症的人禁用。',
      '肾功能不全、高镁/高钙血症、严重心功能不全的人慎用。',
      '妊娠头 3 个月慎用；妊娠 3 个月以上先问医生。',
  ...
  ors: {
    name: '口服补液盐（ORS 冲剂）',
    type: '电解质补充（腹泻/呕吐脱水时用）',
    form: '把 1 袋溶到温水里（ORS Ⅰ/Ⅱ：1 袋对 500ml；ORS Ⅲ：1 袋对 250ml），少量多次喝，腹泻停止就停。别用牛奶/果汁代替水。',
    maxNote: '重度脱水（尿很少、没精神、休克）或严重腹泻吐到喝不进去，要静脉补液，赶紧去医院。',
    contraindications: [
      '少尿/无尿、严重脱水需静脉补液的人，别用口服。',
      '严重腹泻呕吐、葡萄糖吸收障碍、肠梗阻、肠麻痹、肠穿孔的人禁用。',
      '心、肾、脑功能不全及高钾血症的人慎用。',
    ],
    groups: ['electrolyte'],
  },
  ...
  macrogol: {
    ...
    maxNote: '开始前先排除器质性疾病；儿童疗程不超过 3 个月。',
    contraindications: [
      '严重炎症性肠病（溃疡性结肠炎、克罗恩病）或中毒性巨结肠的人禁用。',
      '消化道穿孔、肠梗阻/狭窄、不明原因腹痛的人禁用。',
      '对聚乙二醇或成分过敏的人禁用。',
    ],
    groups: ['laxative_osmotic'],
  },
  ...
  dextromethorphan: {
    ...
    contraindications: [
      '妊娠 3 个月内、有精神病史、哺乳期妇女禁用。',
      '吃单胺氧化酶抑制剂（抗抑郁药）停药不满 2 周的人禁用。',
      '哮喘、痰多、肝肾功能不全的人慎用。',
      '别和单胺氧化酶抑制剂、抗抑郁药一起吃。',
      '别喝酒、别和安眠药等中枢抑制药一起吃。',
      '吃药期间别开车、别操作机器。',
  ...
  hydrocortisone_cream: {
    ...
    contraindications: [
      '感染性皮肤病（破溃、流脓、真菌感染）禁用。',
      '皮肤破溃处别涂。',
      '别接触眼睛、口、鼻。',
      '儿童、孕妇、哺乳期在医生指导下用。',
      '长期用可能皮肤变薄、毛细血管扩张、色素沉着、继发感染。',
    ],
...
const INTERACTIONS = [
  ...
  { a: 'ibuprofen', b: 'diclofenac_gel', rule: 'timed', note: '口服布洛芬 + 外用双氯芬酸凝胶都属于非甾体抗炎药。外用吸收很少，短期可以；但别长期一起大剂量用，尽量分开使用。' },
...
const SYMPTOMS = {
  ...
  sneeze_rhinitis: {
    region: 'ent', name: '打喷嚏/过敏性鼻炎', icon: '🤧',
    questions: [
  ...
  epistaxis: {
    ...
    questions: [
      ...
      { id: 'assoc', label: '伴随？（可多选）', type: 'multi', options: ['鼻子干燥', '经常出血', '头晕/出冷汗', '正在吃抗凝药'] },
    ],
    meds: [],
    ...
    redFlags: [
      ...
      { key: 'assoc', test: a => a.includes('经常出血') || a.includes('正在吃抗凝药'), level: 'doctor',
        tip: '反复鼻出血或正在吃抗凝药，建议就医。' },
    ],
  },
  ...
  rash: {
    ...
    redFlags: [
      { key: 'assoc', test: a => a.includes('压下去不褪色') || a.includes('发烧') && a.includes('眼睛/口腔溃疡'), level: 'urgent',
        tip: '皮疹伴发热、或眼/口腔黏膜溃疡、压之不褪色，可能是重症药疹/过敏，立即就医。' },
    ],
  },
  ...
  insect_bite: {
    ...
    questions: [
      { id: 'assoc', label: '伴随？（可多选）', type: 'multi', options: ['红肿瘙痒', '水疱', '抓破/流脓', '胸闷/喘/起大片荨麻疹'] },
    ],
    meds: ['calamine', 'loratadine'],
    care: '冷敷止痒，涂炉甘石；别抓，破了要注意防感染。',
    redFlags: [
      { key: 'assoc', test: a => a.includes('胸闷/喘/起大片荨麻疹'), level: 'urgent',
        tip: '被咬后胸闷、喘不上气、起大片荨麻疹或脸肿，警惕严重过敏，立即急诊。' },
...
const FEMALE_ABDOMEN_WARNINGS = [
  {
    name: '宫外孕（异位妊娠）', level: 'urgent',
    symptom: '腹痛或盆腔痛、闭经/停经、阴道出血（可带血块），还可有头晕、昏厥、肩部疼痛；约 1/3 的人没有已知危险因素。',
    tip: '育龄女性只要有单侧下腹痛、月经推迟或出血、头晕/肩痛，就要当心；若伴心跳快（>100 次/分）、血压低（<100/60 mmHg）、面色苍白、出冷汗，立即去急诊（破裂出血会危及生命）。',
  },
  {
    name: '妊娠期腹痛的危急重症', level: 'urgent',
    symptom: '中-重度、持续钝痛或短暂撕裂样痛、无法忍受，休息后不缓解或伴其他症状。',
    tip: '可能是流产、胎盘早剥、子宫破裂、附件肿物扭转/破裂等；若疼痛向胸背部放射要想到主动脉夹层，立即去急诊。',
  },
  {
  ...
  },
  {
    ...
    symptom: '下腹坠痛 + 发热 + 异常分泌物，劳累或性生活后加重。',
    tip: '尽快就诊；常需规范抗感染治疗，不要自己乱吃所谓消炎药。',
  },
  {
    name: '异位妊娠/盆腔炎之外的“下腹痛+出血”均须排查', level: 'doctor',
    symptom: '下腹痛伴不规则阴道出血，或伴头晕、乏力、出冷汗。',
    tip: '请就医排查，不要拖延。',
  },
  {
    name: '痛经（经期腹痛，常见且多数可缓解）', level: 'info',
...
const SEVERITY_ADVICE = {
  urgent: {
    ...
    when: '现在 / 今天就过去，别等。',
    where: '直接去<b>大医院（三级甲等）</b>的急诊，或打 120。小医院一般处理不了这种急症，别在小医院耽误时间。',
  },
  doctor: {
    title: '需要去看看医生，但不用太慌',
    paint: '多半是需要“查一查”的程度，早点去排查比较稳妥。',
    when: '这几天（1~3 天内）去挂个号。',
    where: '先去附近的<b>小医院</b>看就行；如果反复发作、越来越重，或医生建议转诊，再上<b>大医院（三级甲等）</b>。',
  },
  self: {
    title: '可以先在家观察',
    paint: '多半是常见的小问题，在家护理 + 按需用药一般能自己缓过来。',
    when: '用药/护理 2~3 天不见好、症状加重、或冒出新的不舒服，再去医院。',
    where: '先到<b>小医院</b>就行；小医院看不了或没把握的，再上<b>大医院（三级甲等）</b>。',
  },
};

/* 医院等级大白话卡片 */
const HOSPITAL_LEVEL_NOTE = '医院叫法：<b>大医院</b>＝三级甲等（专家多、设备全，能处理急症重症）；<b>小医院</b>＝其他普通/社区医院（看常见病足够）。';
