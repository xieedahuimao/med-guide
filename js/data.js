...
const MEDS = {
  ...
  ibuprofen: {
    ...
    contraindications: [
      '对布洛芬、阿司匹林或其他解热镇痛消炎药过敏的人禁用。',
      '孕妇及哺乳期妇女禁用。',
      '一吃阿司匹林就哮喘的人禁用。',
      '有肝病、肾病、心脏病的人禁用。',
      '正在吃其他布洛芬/解热镇痛消炎药的人禁用（除非医生让吃）。',
      '有胃溃疡、消化道出血/穿孔史、或正在胃肠出血的人禁用。',
      '60 岁以上、有哮喘/鼻息肉、凝血障碍、高血压、心功能不全、炎症性肠病（肠子里长期发炎的病）的人慎用（先问医生）。',
      '吃药期间别喝酒。',
    ],
    groups: ['nsaid'],
  },
  ...
  ors: {
    ...
    contraindications: [
      ...
      '严重腹泻呕吐、糖吸收有问题、肠子堵了、肠子不动了、肠子破了的人禁用。',
      '心、肾、脑功能差及血钾太高的人慎用。',
    ],
    groups: ['electrolyte'],
  },
  ...
  lactulose: {
    ...
    contraindications: [
      '肠子堵了、急腹痛、消化道破了的人禁用。',
      '炎症性肠病（肠子里长期发炎的病）的人禁用。',
      '对乳糖/果糖消化不了（很罕见的遗传问题）的人禁用。',
      '对本品过敏的人禁用。',
    ],
  ...
  macrogol: {
    ...
    contraindications: [
      '炎症性肠病（肠子里长期发炎的病）很严重、或肠子胀得很大的人禁用。',
      '消化道破了、肠子堵了、不明原因腹痛的人禁用。',
      '对聚乙二醇或成分过敏的人禁用。',
    ],
    groups: ['laxative_osmotic'],
  },
  ...
  dextromethorphan: {
    ...
    contraindications: [
      '怀孕 3 个月内、有精神病史、哺乳期妇女禁用。',
      '正在吃某种抗抑郁药（单胺氧化酶抑制剂）停药不满 2 周的人禁用。',
      '哮喘、痰多、肝肾功能不全的人慎用。',
      '别和抗抑郁药一起吃。',
      '别喝酒、别和安眠药等中枢抑制药一起吃。',
      '吃药期间别开车、别操作机器。',
...
const INTERACTIONS = [
  ...
  { a: 'ibuprofen', b: 'diclofenac_gel', rule: 'timed', note: '口服布洛芬 + 外用双氯芬酸凝胶都属于解热镇痛消炎药。外用吸收很少，短期可以；但别长期一起大剂量用，尽量分开使用。' },
